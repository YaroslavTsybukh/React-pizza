...
import { clearItems} from "../core/redux/slices/cartSlice";
import {CartEmpty} from "../components/simple/CartEmpty";
            ...
            <span>
              {' '}Сумма заказа: <b>{totalPrice} грн</b>{' '}
                    ...
                    <div className="cart__bottom-buttons">
                        <Link to={ROUTES.HOME} className="button button--outline button--add go-back-btn">
                            <svg
                                width="8"
                                height="14"
                                viewBox="0 0 8 14"
